...
// Product routes
router.post("/add-product", authenticate, isAdmin, upload.single("image"), adminproductController.addProduct);
router.get("/products", productController.getAllProducts);
router.get("/products-with-logs", authenticate, isAdmin, adminproductController.getProductsWithLogs);
router.get("/product-logs/:productId", authenticate, isAdmin, adminproductController.getProductLogs);
...
router.get("/products/sales-performance", authenticate, isAdmin, adminOrderController.getSalesPerformance);
...
router.get("/products/stock-overview", productController.getProductStockOverview);
router.get("/products/stock-changes-over-time", productController.getProductStockChangesOverTime);
router.get("/products/top-selling-products", productController.getTopSellingProducts);
